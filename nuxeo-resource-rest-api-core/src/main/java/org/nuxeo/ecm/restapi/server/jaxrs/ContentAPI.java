...
public class ContentAPI extends DefaultObject {
    ...
    public static final String CUSTOM_RESPONSE_HEADER = "custom-response-header";
    ...
    public Object doGetResource(@PathParam("contentName") String contentName,
                                ...
                                @Context HttpServletResponse response) throws DocumentNotFoundException {
        ...
        if (list.size() == 0) {
            ...
            //set response header
            response.setHeader(CUSTOM_RESPONSE_HEADER,contentId);
            return list.get(0);
        }
    }
}
